...
[[nodiscard]] inline String qwtowb16(size_t value, const unsigned int fills = 1) noexcept {
	String ret;
...
inline String ptrtow(const void* value) { return qwtowb16(reinterpret_cast<unsigned long long>(value), 16); }

[[nodiscard]] inline String qwtowb10(size_t value, const unsigned int fills = 1) noexcept {
